...
import 'package:structurepublic/src/pages/AdminMarketPage.dart';
...
class Cardadmin extends StatefulWidget {
  ...
  const Cardadmin({Key key, this.user}) : super(key: key);
  @override
  _CardadminState createState() => _CardadminState(this.user);
}

class _CardadminState extends State<Cardadmin> {
  _CardadminState(this.user);
            ...
            child: Card(
                ...
                child:Column(children: [
                  ...
                  Expanded(child: ListTile(
                    ...
                    onTap: () {
      Navigator.push(context, MaterialPageRoute(builder: (context) =>PageAdminMarket(user)) );
