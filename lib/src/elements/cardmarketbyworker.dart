...
class CardMarketbyworkerWidget extends StatefulWidget {
  const CardMarketbyworkerWidget (this.marketData);
  ...
  @override
  _CardMarketbyworkerWidgetState createState() {
    return _CardMarketbyworkerWidgetState(this.marketData) ;
  }
}

class _CardMarketbyworkerWidgetState extends State<CardMarketbyworkerWidget> {
  _CardMarketbyworkerWidgetState(this.marketData);
