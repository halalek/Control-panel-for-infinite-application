...
class SignupMain extends StatefulWidget {
  ...
  const SignupMain({Key key, this.v}) : super(key: key);
  @override
  _SignupMain createState() =>  _SignupMain(this.v);
}
...
final int v ;
  ...
  _SignupMain(this.v) : super( LoginController()) {
    // _con = controller;
                                      ...
                                      Container(
                                        ...
                                        onTap: () async {
                                          if (_formKey.currentState.validate()) {
                                               ...
                                               _loginrController.signupfirebase(v);
